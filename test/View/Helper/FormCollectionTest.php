...
class FormCollectionTest extends TestCase
{
    ...
    {
        $this->setExpectedException('RuntimeException', 'Invalid element helper set in FormCollection. The helper must be an instance of Laminas\View\Helper\HelperInterface.');
